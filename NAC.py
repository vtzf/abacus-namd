...
def NACcalc():
    ...
    e_occ_p, vec_p = NACfunc.LoadDataOrbital(
                     Args.nstep,'float64',myid,nidx,idx_range)
    olp_p = NACfunc.LoadDataOlp(
            Args.nstep,'float64',myid,nidx,idx_range)
